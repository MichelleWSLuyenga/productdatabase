...
<body>
	...
	<form method="post" name="rpl_report" action="repair_location_report.php" target="report_iframe">
		<div class="row">
			...
			<div class="col-md-2">
				<select class="form-control" name="repair_site" required="required" onchange="site_selected(this.value);">
					<option></option>
			...
			<div class="col-md-2">
				<select class="form-control" name="complete" required="required" onchange="status_selected(this.value);">
					<option></option>
					<option value="All">All</option>
		...
		<div class="row">
			<form name="print_receipt" method="post" action="receipt.php">
				<div class="col-md-4">
					<input type="text" name="form_num" placeholder="Form Number" class="form-control" required="required">
				</div>
				<div class="col-md-4">
